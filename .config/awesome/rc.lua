...
{description = "focus prev empty tag", group = "tag"}),
        ...
        function () awful.spawn.with_shell("xdotool getactivewindow >> ~/.marked_loe_windows") end),
        awful.key({ modkey,  }, "End",
        function () awful.spawn.with_shell("rm ~/.marked_loe_windows") end),
